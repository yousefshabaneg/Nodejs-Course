...
/* eslint-disable */
var hideAlert = function hideAlert(type, msg) {
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          endpoint = type === 'password' ? 'updateMyPassword' : 'me';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://localhost:3000/api/v1/users/".concat(endpoint),
            data: data
          });
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWdrdGlrMyIsImEiOiJjbGQ1ajBvN2wwbXhjM25rYjRua3d0YTl1In0.tEDBjvTTaxTXdKbUUubO3g';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/egktik3/cld5kp2lo001r01kayx5hw9fw',
    // style URL
    scrollZoom: false // center: locations[0].coordinates, // starting position [lng, lat]
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).setLngLat(loc.coordinates).addTo(map); //Extends map bounds to include current location
...
var publicKey = 'pk_test_51MUQCVCaMPNeXJNjuSeT8wlifrrqAG63fq0dQuZm514jmGzy5S3Fuls2F9KxN5Iuv2FW1MpdYZCt25x66qpJng9300xhLuPEFI';
...
var changePasswordForm = document.querySelector('.form.form-user-settings');
var logOutBtn = document.querySelector('.nav__el--logout');
var bookBtn = document.getElementById('book-tour'); //Map Box
  ...
  function () {
    ...
    _regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); //multipart form data: upload images
